...
const buttonBase =
  'inline-flex min-h-14 items-center justify-center gap-2 rounded-full px-8 text-base font-black transition focus:outline-none focus:ring-4 focus:ring-cyan-300/30';
...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden bg-slate-50 px-4 pb-28 pt-24 text-slate-950 dark:bg-slate-950 dark:text-white sm:px-6 lg:px-8 lg:pt-28">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.12fr_0.88fr]">
        ...
        >
          <h1 className="max-w-4xl text-5xl font-black leading-[1.08] text-slate-950 dark:text-white sm:text-6xl lg:text-7xl">
            Welcome To <span className="text-cyan-400">My</span>
            <span className="block text-cyan-500 dark:text-cyan-300">Portfolio!</span>
          </h1>
          <p className="mt-9 flex max-w-3xl flex-wrap items-center gap-x-2 text-2xl font-semibold text-slate-800 dark:text-white/90 sm:text-3xl">
        ...
        >
          <div className="relative grid aspect-square w-64 place-items-center rounded-full border-[6px] border-cyan-400 bg-white p-2 shadow-[0_0_42px_rgba(6,182,212,0.42)] transition duration-500 ease-out hover:scale-105 hover:rotate-2 sm:w-72 lg:w-80">
            <img
              src={heroImage}
