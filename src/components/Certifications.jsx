...
export default function Certifications() {
  return (
    <section
      id="certifications"
      className="bg-gradient-to-br from-slate-50 via-cyan-50/30 to-white px-4 py-12 text-slate-950 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-white sm:px-6 sm:py-20 lg:px-8"
    >
      <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        <div className="mx-auto mb-8 max-w-4xl text-center sm:mb-14">
          <h2 className="text-3xl font-black text-slate-800 dark:text-white sm:text-5xl">Certifications</h2>
          ...
          <div className="flex snap-x snap-mandatory gap-4 sm:gap-5">
            {certifications.map((certificate) => (
              <article
                ...
                className="group min-w-[82%] snap-start overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.10)] transition duration-300 hover:-translate-y-1 hover:border-cyan-300 hover:shadow-[0_24px_70px_rgba(6,182,212,0.18)] dark:border-white/10 dark:bg-slate-950/70 sm:min-w-[calc((100%_-_2.5rem)_/_3)]"
              >
